...
train_dir = "/home/ws2080/Desktop/data/ucmayo4/cross_validation_folds/fold_0/train"
val_dir = "/home/ws2080/Desktop/data/ucmayo4/cross_validation_folds/fold_0/val"
...
if use_lrscheduling:
    scheduler = lr_scheduler.ReduceLROnPlateau(optimizer, mode="max", factor=0.2, patience=LRScheduling_patience, threshold=best_threshold,
                                           verbose=True)
